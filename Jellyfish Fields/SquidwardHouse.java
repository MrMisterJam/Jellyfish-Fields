...
/**
 * A classe SquidwardHouse representa a casa do Squidward que cai no jogo.
 * A casa se move para baixo e sacode enquanto desce.
 * Quando atinge o jogador, ele é repelido.
 * 
 * @autor SeuNome
 * @versão DataOuVersão
 */
public class SquidwardHouse extends Actor {
    ...
    protected void addedToWorld(World world) {
        ...
        targetY = world.getHeight() - getImage().getHeight() / 2; // Define o alvo como próximo à base do mundo
